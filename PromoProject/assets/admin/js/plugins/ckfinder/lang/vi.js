...
CKFinder.lang['vi'] =
{
    ...
    FilesDelete: 'Bạn có chắc muốn xóa danh sách tập tin %1?',
    FilesLoading: 'Đang tải...',
    FilesEmpty: 'Thư mục trống.',
    DestinationFile: 'Tập tin đến',
    SkippedFiles: 'Danh sách tập tin bỏ qua:',
    ...
    BasketRemoveConfirmMultiple: 'Bạn có chắc muôn xóa nhưng tập tin %1 ra khỏi giỏ?',
    ...
    // Global messages
    OperationCompletedSuccess: 'Hành động được hoàng.',
    OperationCompletedErrors: 'Hàng động hoàn thành với lỗi.',
    FileError: '%s: %e',

    // Move and Copy files
    MovedFilesNumber: 'Số tập tin được di chuyển: %s.',
    CopiedFilesNumber: 'Số tập tin được copy: %s.',
    MoveFailedList: 'Đây là nhưng tập tin không thể di chuyển:<br />%s',
    CopyFailedList: 'Đây là nhưng tập tin không thể copy:<br />%s',
    ...
    ManuallyRename: 'Hướng dẫn đổi tên',
    ...
    Errors:
	{
	    ...
	    111: 'Không thể hoàn thành yêu cầu do kích thước tập tin.',
    ...
    ErrorMsg:
	{
	    ...
	    FolderExists: 'Thư muc %s đang tồn tại.',
	    FolderNameExists: 'Các thư mục đã tồn tại.',
    ...
    Zip:
	{
	    extractHereLabel: 'Giải nén tại đây',
	    extractToLabel: 'Giải nén tới...',
	    downloadZipLabel: 'Tải dạng zip',
	    compressZipLabel: 'Nén thành zip',
	    removeAndExtract: 'Xóa tồn tại và giải nén',
	    extractAndOverwrite: 'Giải nén đè cái đã có',
	    extractSuccess: 'Giải nén tập tin thành công.'
	},
