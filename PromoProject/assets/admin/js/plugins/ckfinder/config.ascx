...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        //if (QcWorkContext.CurrentCustomer != null && QcWorkContext.HaveInPermission(PermissionConstants.FileManager))
        //    return true;
        //return false;
        return true;
    }
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "JFBQ00159070207B";
        LicenseKey = "JFBQ00159070207B";

        // The base URL used to reach files in CKFinder through the browser.
        //BaseUrl = WorkSetting.EditorSetting.BaseUrl;
        BaseUrl = "/Image/";

        // The phisical directory in the server where the file will end up. If
        // blank, CKFinder attempts to resolve BaseUrl.
        //BaseDir = HttpWebUtility.ServerPath(WorkSetting.EditorSetting.BaseDir);
        BaseDir = "";
        ...
        type.Url = BaseUrl + "/editorfiles" + DateTime.Now.ToString("/yyyy/MM/dd/");
        type.Dir = BaseDir == "" ? "" : BaseDir + "\\editorfiles" + DateTime.Now.ToString("/yyyy/MM/dd/").Replace('/', '\\');
        type.MaxSize = 512000;
        ...
        type.Url = BaseUrl + "/editorimages" + DateTime.Now.ToString("/yyyy/MM/dd/");
        type.Dir = BaseDir == "" ? "" : BaseDir + "\\editorimages" + DateTime.Now.ToString("/yyyy/MM/dd/").Replace('/', '\\');
        type.MaxSize = 512000;
        type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add("Flash");
        type.Url = BaseUrl + "/editorflash" + DateTime.Now.ToString("/yyyy/MM/dd/");
        type.Dir = BaseDir == "" ? "" : BaseDir + "\\editorflash" + DateTime.Now.ToString("/yyyy/MM/dd/").Replace('/', '\\');
        type.MaxSize = 1024000;
